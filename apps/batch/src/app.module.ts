...
@Module({
  imports: [
    ...
    BullModule.registerQueue(
      { name: 'incheon-flight', limiter: { max: 3, duration: 1000 } },
      { name: 'kac-flight',     limiter: { max: 2, duration: 1000 } },
      { name: 'incheon-parking', limiter: { max: 3, duration: 1000 } },
      { name: 'kac-parking',    limiter: { max: 2, duration: 1000 } },
      { name: 'immigration',    limiter: { max: 2, duration: 1000 } },
      { name: 'weather',        limiter: { max: 1, duration: 1000 } },
      { name: 'notification',   limiter: { max: 10, duration: 1000 } },
    ),
